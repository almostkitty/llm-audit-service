"""
Разбор и очистка сырого текста ВКР: рефераты, введение+главы, фильтр артефактов.
...
def strip_trailing_bibliography_section(text: str) -> str:
    """
    Удаляет хвост от заголовка списка литературы / источников.
...
# Типичные старты строк кода (Python/Java/JS/SQL/C и т.д.)
_CODE_KW = re.compile(
    r"(?i)^[\s\u00a0]*("
